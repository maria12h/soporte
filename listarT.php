...
$peticion = $peticion = "SELECT * FROM tecnico  ORDER BY idtecnico ASC ";
...
<div class='ventana_flotante'>
	...
	<section id='main' class='column'>
		...
		<article class='module width_full'>
			<header><h3>Lista de operadores</h3></header>
<form action='buscaroperador.php' method='POST'><input id ='buscar' name='nombreso' value='' type='text'> <input id ='btnbuscar' type='submit' value='Buscar operador'></form >
...
echo'<td>'.$fila['idtecnico']." ".'</td>'.'<td>'.$fila['nombre'].'</td>'.'<td>'.$fila['apellido']."".'<td>'.$fila['telefono']."".'</td>'.'<td>'.$fila['especialidad']."".'</td>'.'<td><a href="actualizartecnico.php?idreT='.$fila['idtecnico'].'"><input type="submit" value="Modificar" id="modiboton"  title="Modificar"></a>'.'<td><a href="eliminratecnico.php?idreTe='.$fila['idtecnico'].'"><input type="submit" id="booelimar" value="Elinimar" title="Eliminar"></a></td>';
					echo"</tr>";
				} 
