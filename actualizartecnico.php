...
<form action='consultActualizarT.php' method='POST'>
			...
			";
                              ...
                              $_SESSION['IdeAte']=$idte;
                               ...
                               $tildes =$conexion->query("SET NAMES 'utf8'");
										$peticion = "SELECT * FROM tecnico WHERE idtecnico='$idte'";
						...
						while($fila = mysqli_fetch_array($resultado)) {  
						 echo "
		                    <tr>
									...
									<td>
										<input name='nombres' type='text' value='".$fila['nombre']."' placeholder='Nombre'></td>
									</td>
							</tr>
		               	    <tr>
									<td>
									...
									<td>
									<input name='apellido' type='text' value='".$fila['apellido']."' placeholder='Apellido'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='dir' type='text'  value='".$fila['direccion']."' placeholder='Dirección'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='tele' type='text' value='".$fila['telefono']."' placeholder='Teléfono'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='correo' type='text' value='".$fila['correo']."' placeholder='Correo'></td>
									</td>
							</tr>
							<tr>
									<td>
									...
									<td>
									<input name='especi' type='text' value='".$fila['especialidad']."' placeholder='Especialidad'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='usuario' type='text' value='".$fila['login']."' placeholder='usuario'></td>
									</td>
							</tr>
							  <tr>
									<td>
									...
									<td>
									<input type='text' name='contrasena' value='".$fila['clave']."' placeholder='contraseña'></td>
									</td>
							</tr>
                          ";
                         	}
