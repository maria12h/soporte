...
<div class='ventana_flotante'>
	...
	<section id='main' class='column'>
		...
		<article class='module width_full'>
			<header><h3>Ingresar nueva incidencia</h3></header>
<form action='consultainsertarincidencia.php' method='POST'>
			...
			";
						 ...
						 echo "
		                    <tr>
									...
									<td>
										<input name='nombres' type='text' placeholder='NombreIncidencia'></td>
									</td>
							</tr>
