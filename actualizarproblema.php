...
<form action='consultaactualizarproblema.php' method='POST'>
			...
			";
                              ...
                              $_SESSION['IdeAte']=$idte;
                               ...
                               $tildes=$conexion->query("SET NAMES 'utf8'");
										$peticion = "SELECT * FROM problema WHERE idproblema='$idte'";
						...
						while($fila = mysqli_fetch_array($resultado)) {  
						 echo "
		                    <tr>
									...
									<td>
										<input name='nombres' type='text' value='".$fila['nom_problema']."' placeholder='Nombre'></td>
									</td>
							</tr>
