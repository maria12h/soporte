...
<div class='ventana_flotante'>
	...
	<section id='main' class='column'>
		...
		<article class='module width_full'>
			<header><h3>Ingresar nuevo operadores</h3></header>
<form action='consultainsertartecnico.php' method='POST'>
			...
			";
						 ...
						 echo "
		                    <tr>
									...
									<td>
										<input name='nombres' type='text' placeholder='Nombre'></td>
									</td>
							</tr>
		               	    <tr>
									<td>
									...
									<td>
									<input name='apellido' type='text' placeholder='Apellido'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='dir' type='text' placeholder='Dirección'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='tele' type='text' placeholder='Teléfono'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='correo' type='text' placeholder='Correo'></td>
									</td>
							</tr>
							<tr>
									<td>
									...
									<td>
									<input name='especi' type='text' placeholder='Especialidad'></td>
									</td>
							</tr>
							 <tr>
									<td>
									...
									<td>
									<input name='usuario' type='text' placeholder='usuario'></td>
									</td>
							</tr>
							  <tr>
									<td>
									...
									<td>
									<input type='password' name='contrasena' placeholder='contraseña'></td>
									</td>
							</tr>
                          ";
                           ...
                           $tildes =$conexion->query("SET NAMES 'utf8'");
			                    	 ...
			                    	 echo "<tr><td> Tipo de administrador: </td>";	
									 echo "<td><select name='tipo'>";
									 echo "<option  value='AD'>Adminitrador</option>";
									 echo "<option value='T'>Operadorer</option>";
			               	    	 echo "</select></td></tr>";	
