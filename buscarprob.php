...
<div class='ventana_flotante'>
	...
	<section id='main' class='column'>
		...
		<article class='module width_full'>
			<center><header><h3>Lista de areas encontrados</h3></header></center>
		<table border=1 width=950px;>
			";
				...
				$peticion = $peticion = "SELECT * FROM problema WHERE  nom_problema like '%$buscar%' ";
				...
				//if($estado == 0){$diestado = "no servido";}else{$diestado = "servido";}
					echo'<td>'.$fila['idproblema']." ".'</td>'.'<td>'.$fila['nom_problema'].'';
					echo"</tr>";
				} 
